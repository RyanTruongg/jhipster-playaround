...
import com.leaptraining.bugtracker.repository.TicketRepository;
...
class TicketResourceIT {
    ...
    public static Ticket createEntity(EntityManager em) {
        Ticket ticket = new Ticket().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION).dueDate(DEFAULT_DUE_DATE)
                .done(DEFAULT_DONE);
        return ticket;
    }
    ...
    public static Ticket createUpdatedEntity(EntityManager em) {
        Ticket ticket = new Ticket().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).dueDate(UPDATED_DUE_DATE)
                .done(UPDATED_DONE);
        return ticket;
    }
    ...
    void putNewTicket() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedTicket are not directly
        // saved in db
        em.detach(updatedTicket);
        updatedTicket.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).dueDate(UPDATED_DUE_DATE)
                .done(UPDATED_DONE);
    ...
    void fullUpdateTicketWithPatch() throws Exception {
        ...
        partialUpdatedTicket.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).dueDate(UPDATED_DUE_DATE)
                .done(UPDATED_DONE);
